...
public class Principal {
    ...
    private final String API_KEY = "&apikey=1af1fc27";
    ...
    public void exibeMenu() {
        ...
        while (opcao != 0) {
            var menu = """
                    ...
                    4 - "Buscar Série Por Trecho de Título"
                    5 - Buscar Série Por Ator
                    6 - Top 5 Séries
                    7 - Buscar Série Por Categoria
                    8 - Filtrar séries
                    9 - Filtrar trecho de episódio
    ...
    private void buscarSerieWeb() {
        ...
        try {
            ...
            System.out.println("Erro: Você já buscou e salvou essa série anteriormente.");
        }
    ...
    private void buscarSeriePorTitulo() {
        System.out.println("Escolha uma série pelo trecho de nome: ");
        var nomeSerie = scanner.nextLine();
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Categoria/Gênero? ");
